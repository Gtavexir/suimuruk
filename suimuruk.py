...
async def 알고(ctx):
    ...
    embed.add_field(name="1페이즈", value="700G, 어금니 6, 발톱 16, 선혈 1, 힘줄 1", inline=False)
    embed.add_field(name="2페이즈", value="400G, 어금니 2, 발톱 5, 선혈 2, 힘줄 2", inline=False)
    embed.add_field(name="3페이즈", value="500G, 어금니 1, 발톱 2, 선혈 3, 힘줄 3", inline=False)
    await ctx.send(embed=embed)
